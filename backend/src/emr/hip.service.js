...
// Encrypt FHIR bundle with HIU's public key
// ABDM uses Weierstrass Curve25519 (BouncyCastle) — 65-byte uncompressed EC point (04||x||y)
// Nonce arrives as base64 and must be decoded to raw bytes before KDF
