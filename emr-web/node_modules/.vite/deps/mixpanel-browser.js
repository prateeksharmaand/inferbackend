...
var Mirror = function() {
  ...
  _proto.removeNodeFromMap = function removeNodeFromMap2(n2, permanent) {
    var _this = this;
...
var __viteBrowserExternal$1$2 = Object.freeze(Object.defineProperty({
  __proto__: null,
  default: __viteBrowserExternal$3
}, Symbol.toStringTag, {
  value: "Module"
}));
var require$$2$2 = getAugmentedNamespace$2(__viteBrowserExternal$1$2);
var pico$2 = picocolors_browserExports$2;
var terminalHighlight$1$2 = require$$2$2;
var CssSyntaxError$3$2 = function(Error1) {
...
var Node$3$2 = node$2;
var Declaration$4$2 = function(Node$3$22) {
...
var Node$2$2 = node$2;
var Comment$4$2 = function(Node$2$22) {
...
var Container$7$2 = function(Node$1$22) {
  ...
  _proto.normalize = function normalize(nodes, sample) {
    ...
    var processed = nodes.map(function(i22) {
      if (!i22[my$1$2]) Container23.rebuild(i22);
      i22 = i22.proxyOf;
      if (i22.parent) i22.parent.removeChild(i22);
      if (i22[isClean$1$2]) markDirtyUp$2(i22);
      if (typeof i22.raws.before === "undefined") {
        if (sample && typeof sample.raws.before !== "undefined") {
          i22.raws.before = sample.raws.before.replace(/\S/g, "");
        }
...
var LazyResult$4$2;
var Processor$3$2;
var Document$3$2 = function(Container$6$22) {
...
var AtRule$3$2 = function(Container$5$22) {
...
var LazyResult$3$2;
var Processor$2$2;
var Root$5$2 = function(Container$4$22) {
...
var Rule$3$2 = function(Container$3$22) {
...
var postcss$1$2 = getDefaultExportFromCjs$2(postcss_1$2);
  ...
  function MutationBuffer2() {
    ...
    __publicField$1(this, "emit", function() {
      ...
      var pushAdd = function(n22) {
        var parent2 = index$2.parentNode(n22);
        ...
        var sn = serializeNodeWithId(n22, {
          ...
          onSerialize: function(currentN) {
            ...
            if (hasShadowRoot(n22)) {
              _this.shadowDomManager.addShadowRoot(index$2.shadowRoot(n22), _this.doc);
            }
          },
...
function record(options) {
  ...
  wrappedEmit = function(r2, isCheckout) {
    ...
    if (inEmittingFrame) {
      ...
      if (validatedOrigins) {
        for (var _iterator2 = _create_for_of_iterator_helper_loose(validatedOrigins), _step2; !(_step2 = _iterator2()).done; ) {
          var targetOrigin = _step2.value;
...
var Container$7 = function(Node$12) {
  ...
  _proto.normalize = function normalize(nodes, sample) {
    ...
    var processed = nodes.map(function(i2) {
      if (!i2[my$1]) Container.rebuild(i2);
      i2 = i2.proxyOf;
...
var Document$3 = function(Container$62) {
  _inherits(Document3, Container$62);
  function Document3(defaults) {
    var _this;
  ...
  var _proto = Document3.prototype;
  _proto.toResult = function toResult(opts) {
    if (opts === void 0) opts = {};
...
var LazyResult$2 = function() {
  ...
  _proto.runAsync = function runAsync() {
    var _this = this;
    return _async_to_generator(function() {
      var i, plugin22, promise, error, root2, stack, promise1, e, node2, _loop, _iterator, _step;
      return _ts_generator(this, function(_state) {
        switch (_state.label) {
          case 0:
            _this.plugin = 0;
          ...
          case 14:
            ...
            _loop = function() {
              var _step_value, plugin23, visitor, roots, e2;
              return _ts_generator(this, function(_state2) {
                switch (_state2.label) {
                  case 0:
...
var postcss$1 = getDefaultExportFromCjs$3(postcss_1);
postcss$1.stringify;
postcss$1.fromJSON;
postcss$1.plugin;
postcss$1.parse;
...
var canUseCompressionStream = function(userAgent2, vendor, opera) {
  ...
  var browser = _.info.browser(userAgent2, vendor, opera);
  var version = _.info.browserVersion(userAgent2, vendor, opera);
...
var validateAllowedOrigins = function(origins, logger2) {
  if (!_.isArray(origins)) {
    if (origins) {
      logger2.critical("record_allowed_iframe_origins must be an array of origin strings, cross-origin recording will be disabled.");
    }
    return [];
  }
  var valid = [];
  for (var i = 0; i < origins.length; i++) {
    try {
      ...
      if (origin === "null") {
        logger2.critical(origins[i] + " has an opaque origin. Skipping this entry.");
        continue;
      }
      valid.push(origin);
    } catch (e) {
      logger2.critical(origins[i] + " is not a valid origin URL. Skipping this entry.");
    }
  }
  return valid;
};
...
function getTimeOrigin(win2) {
  return Math.round(Date.now() - win2.performance.now());
}
...
function initPerformanceObserver(cb, win2, options) {
  if (!win2.PerformanceObserver) {
    logger$5.error("PerformanceObserver not supported");
    return function() {
    };
  }
  if (options.recordInitialRequests) {
    var initialPerformanceEntries = win2.performance.getEntries().filter(function(entry) {
      return isNavigationTiming(entry) || isResourceTiming(entry) && options.initiatorTypes.includes(entry.initiatorType);
    });
    cb({
      requests: initialPerformanceEntries.map(function(entry) {
        return {
          ...
          timeOrigin: getTimeOrigin(win2)
        };
      }),
      isInitial: true
    });
  }
  var observer = new win2.PerformanceObserver(function(entries) {
    var performanceEntries = entries.getEntries().filter(function(entry) {
      return isResourceTiming(entry) && options.initiatorTypes.includes(entry.initiatorType) && entry.initiatorType !== "xmlhttprequest" && entry.initiatorType !== "fetch";
    });
    cb({
...
function tryReadXHRBody(body) {
  ...
  if (typeof body === "string") {
    ...
    result2 = body.textContent;
  } else if (body instanceof FormData) {
    result2 = _.HTTPBuildQuery(body);
  } else if (_.isObject(body)) {
    try {
      result2 = JSON.stringify(body);
    } catch (e) {
  ...
  return truncateBody(result2);
}
function tryReadFetchBody(r) {
  return new Promise(function(resolve2) {
    var timeout = setTimeout(function() {
      resolve2("Timeout while trying to read body");
    }, 500);
    try {
      r.clone().text().then(
        function(txt) {
          clearTimeout(timeout);
          resolve2(truncateBody(txt));
        },
        function(reason) {
          clearTimeout(timeout);
          resolve2("Failed to read body: " + String(reason));
        }
      );
    } catch (e) {
      clearTimeout(timeout);
      resolve2("Failed to read body: " + String(e));
    }
  });
}
function getRequestPerformanceEntry(win2, initiatorType, url, after, before, attempt) {
  if (attempt === void 0) {
    attempt = 0;
  }
  if (attempt > 10) {
  ...
  var urlPerformanceEntries = (
    /** @type {PerformanceResourceTiming[]} */
    win2.performance.getEntriesByName(url)
  );
  var performanceEntry = findLast(
    urlPerformanceEntries,
    function(entry) {
      return isResourceTiming(entry) && entry.initiatorType === initiatorType && (!after || entry.startTime >= after) && (!before || entry.startTime <= before);
    }
  );
  if (!performanceEntry) {
    return new Promise(function(resolve2) {
      setTimeout(resolve2, 50 * attempt);
    }).then(function() {
...
function initXhrObserver(cb, win2, options) {
  if (!options.initiatorTypes.includes("xmlhttprequest")) {
    return function() {
    };
  }
  var restorePatch = patch(
    win2.XMLHttpRequest.prototype,
    "open",
...
function initFetchObserver(cb, win2, options) {
  if (!options.initiatorTypes.includes("fetch")) {
    return function() {
    };
  }
  var restorePatch = patch(win2, "fetch", function(originalFetch) {
    return function() {
      ...
      var requestBodyPromise = Promise.resolve(void 0);
      var responseBodyPromise = Promise.resolve(void 0);
      try {
        var requestHeaders = {};
        ...
        networkRequest.requestHeaders = requestHeaders;
        if (shouldRecordBody("request", options.recordBodyUrls, req.url)) {
          requestBodyPromise = tryReadFetchBody(req).then(function(body) {
            networkRequest.requestBody = body;
          });
        }
        after = win2.performance.now();
        originalFetchPromise = originalFetch.apply(win2, arguments).then(function(response) {
          res = response;
          before = win2.performance.now();
          var responseHeaders = {};
          ...
          networkRequest.responseHeaders = responseHeaders;
          if (shouldRecordBody("response", options.recordBodyUrls, req.url)) {
            responseBodyPromise = tryReadFetchBody(res).then(function(body) {
      ...
      Promise.all([requestBodyPromise, responseBodyPromise, originalFetchPromise]).then(function() {
        return getRequestPerformanceEntry(win2, "fetch", req.url, after, before);
      }).then(function(entry) {
        if (!entry) {
...
function initNetworkObserver(callback, win2, options) {
  if (!("performance" in win2)) {
    return function() {
    };
  }
  ...
  var cb = function(data) {
    ...
    if (requests.length > 0 || data.isInitial) {
      callback(Object.assign({}, data, { requests }));
    }
  };
  var performanceObserver = initPerformanceObserver(cb, win2, networkOptions);
  var xhrObserver = initXhrObserver(cb, win2, networkOptions);
  var fetchObserver = initFetchObserver(cb, win2, networkOptions);
  return function() {
    performanceObserver();
    xhrObserver();
    fetchObserver();
...
function requireLogic() {
  ...
  (function(module, exports) {
    (function(root2, factory) {
      ...
      jsonLogic2.is_logic = function(logic2) {
      ...
      jsonLogic2.get_operator = function(logic2) {
        return Object.keys(logic2)[0];
      };
      jsonLogic2.get_values = function(logic2) {
        return logic2[jsonLogic2.get_operator(logic2)];
      };
      jsonLogic2.apply = function(logic2, data) {
        if (Array.isArray(logic2)) {
          return logic2.map(function(l) {
            return jsonLogic2.apply(l, data);
          });
        }
        if (!jsonLogic2.is_logic(logic2)) {
          return logic2;
        }
        var op = jsonLogic2.get_operator(logic2);
      ...
      jsonLogic2.uses_data = function(logic2) {
        var collection = [];
        if (jsonLogic2.is_logic(logic2)) {
          var op = jsonLogic2.get_operator(logic2);
          var values = logic2[op];
      ...
      jsonLogic2.rule_like = function(rule2, pattern) {
        if (pattern === rule2) {
          return true;
        }
        if (pattern === "@") {
        ...
        if (pattern === "array") {
          return Array.isArray(rule2) && !jsonLogic2.is_logic(rule2);
        }
        if (jsonLogic2.is_logic(pattern)) {
          if (jsonLogic2.is_logic(rule2)) {
            var pattern_op = jsonLogic2.get_operator(pattern);
            var rule_op = jsonLogic2.get_operator(rule2);
            if (pattern_op === "@" || pattern_op === rule_op) {
              return jsonLogic2.rule_like(
                jsonLogic2.get_values(rule2, false),
        ...
        if (Array.isArray(pattern)) {
          if (Array.isArray(rule2)) {
            ...
            for (var i = 0; i < pattern.length; i += 1) {
              if (!jsonLogic2.rule_like(rule2[i], pattern[i])) {
                return false;
              }
            }
            return true;
...
var jsonLogic = getDefaultExportFromCjs(logicExports);
...
RageClickTracker.prototype.isRageClick = function(event, options) {
  ...
  var x2 = event["pageX"], y = event["pageY"];
...
DeadClickTracker.prototype.startTracking = function() {
  ...
  INTERACTION_EVENTS.forEach(function(event) {
    ...
    self.eventListeners.push({ target: document, event, handler, options: { capture: true, passive: true } });
  });
  NAVIGATION_EVENTS.forEach(function(event) {
    ...
    self.eventListeners.push({ target: window, event, handler });
  });
  LAYOUT_EVENTS.forEach(function(event) {
    ...
    self.eventListeners.push({ target: window, event, handler, options: { passive: true } });
  });
...
var getTargetingPromise = function(loadExtraBundle, targetingSrc) {
  ...
  win[TARGETING_GLOBAL_NAME] = new Promise(function(resolve2) {
    loadExtraBundle(targetingSrc, resolve2);
  }).then(function() {
...
var FeatureFlagPersistence = function(persistenceConfig, token, isGloballyDisabled) {
  ...
  this.isGloballyDisabled = isGloballyDisabled || function() {
    return false;
  };
};
...
FeatureFlagPersistence.prototype.getTtlMs = function() {
  ...
  return configuredTtl === void 0 || configuredTtl === null ? DEFAULT_TTL_MS : configuredTtl;
};
FeatureFlagPersistence.prototype._isConfigValid = function() {
  ...
  if (config["persistenceTtlMs"] !== void 0 && config["persistenceTtlMs"] !== null && config["persistenceTtlMs"] <= 0) {
...
FeatureFlagPersistence.prototype.loadFlagsFromStorage = function(context) {
  ...
  return this.idb.init().then(_.bind(function() {
    ...
    var persistedFlags = /* @__PURE__ */ new Map();
...
FeatureFlagManager.prototype.init = function() {
  ...
  this.persistenceLoadedPromise = this.persistence.loadFlagsFromStorage(this._buildContext()).then(_.bind(function(loaded) {
    if (loaded) {
...
FeatureFlagManager.prototype.getVariant = function(featureName, fallback) {
  if (!this.persistenceLoadedPromise) {
    return new Promise(function(resolve2) {
      ...
      resolve2(withFallbackSource(fallback));
    });
  }
...
FeatureFlagManager.prototype.getAllVariantsSync = function() {
  ...
  return this.flags || /* @__PURE__ */ new Map();
};
...
RecorderManager.prototype.checkAndStartSessionRecording = function(force_start, rate) {
  ...
  if (force_start || is_sampled) {
    ...
    return this.shouldLoadRecorder().then(_.bind(function(shouldLoad) {
      if (shouldLoad) {
  ...
  if (!isRecording && recordingTriggerEvents) {
    ...
    if (trigger && typeof trigger["percentage"] === "number") {
      ...
      if (propertyFilters && !_.isEmptyObject(propertyFilters)) {
        ...
        getTargetingPromise(this.loadExtraBundle, targetingSrc).then((function(targeting) {
          try {
            var result2 = targeting["eventMatchesCriteria"](
              event_name,
              properties,
              {
