...
import { LayoutTemplate, Settings2, ChevronLeft } from 'lucide-react';
...
export default function WriteRx() {
  ...
  const addMed = () => set('medications', [...form.medications, { name: '', dosage: '', frequency: '', duration: '', instructions: '' }]);
      ...
      <div className={styles.topbar}>
        ...
        <div className={styles.patientInfo}>
          <span className={styles.patientName}>
            {appt ? appt.patient_name : 'Write Rx'}
          </span>
          {appt && (
      ...
      <div className={styles.subbar}>
        ...
        <div className={styles.linkBtns}>
          <button className={styles.linkBtn}>
            <LayoutTemplate size={13} strokeWidth={1.8} /> Templates
          </button>
          <button className={styles.linkBtn}>
            ...
            <section className={styles.section}>
              ...
              {form.medications.map((m, i) => (
                <div key={i} className={styles.medRow}>
                  ...
                  <input placeholder="Duration (e.g. 5d)"   value={m.duration}    onChange={e => updateMed(i, 'duration',    e.target.value)} />
                  <button className={styles.removeMed}
